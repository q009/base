...
namespace fx
{
            ...
            case FX_PART_TYPE_SINGLE:
            {
                ...
                if(regdelay)
                    regular_part_create(
                        ...
                        inst.getextprop<int>(FX_PART_COLRADIUS),
                        trackent,
                        regdelay
                    );
                else
    ...
    static void soundfx(instance &inst)
    {
        ...
        else if(!inst.emitted) // first emission
        {
            ...
            playsound(
                ...
                from,
                NULL,
                inst.getextprop<int>(FX_SOUND_FLAGS) | SND_UNMAPPED,
                vol,
    ...
    static void windfx(instance &inst)
    {
        ...
        addwind(
            ...
            inst.getextprop<int>(FX_WIND_ATTEN)
        );
    }
